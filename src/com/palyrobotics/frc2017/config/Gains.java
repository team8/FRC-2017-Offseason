...
public class Gains {
	...
	public static double kSteikLeftTrajectorykV = 0.052;//0.077;//0.069;
	public static double kSteikRightTrajectorykV = 0.0526;//0.077;//0.069;
	public static double kSteikLeftTrajectorykV_0 = 0.0904;
	public static double kSteikRightTrajectorykV_0 = 0.102;
	public static double kSteikTrajectorykA = 0.025;//0.037;

	public static double kSteikLeftTurnTrajectorykP = 1.07;//0.40;//0.38;
	public static double kSteikLeftTurnTrajectorykD = 0.023;//0.0155;//0.01;//0.01;
	public static double kSteikLeftTurnTrajectoryTurnkP = 0;//0.01; //-0.01
	public static double kSteikLeftTurnTrajectoryTurnkD = 0;
	...
	public static final double kSteikTrajectoryStraightkP = 1.07; // 1
	public static final double kSteikTrajectoryStraightkD = 0.023;//0.0097077;//0.025; // 0.02
...
//	public static double kSteikTrajectoryStraightTurnkD = 0.01;
	...
	public static double kSteikRightTurnTrajectorykP = 1.07;	//0.40;//0.38//0.42;
	public static double kSteikRightTurnTrajectorykD = 0.023;	//0.01;//0.01//0.0155;
	public static double kSteikRightTurnTrajectoryTurnkP = 0;	//0.01; //-0.01/0.02
	public static double kSteikRightTurnTrajectoryTurnkD = 0;	//0.02;
